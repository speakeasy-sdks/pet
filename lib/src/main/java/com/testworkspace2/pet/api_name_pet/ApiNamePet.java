...
import com.testworkspace2.pet.api_name_pet.utils.SpeakeasyHTTPClient;

public class ApiNamePet {
	/**
	...
	public static class Builder {
		...
		public Builder setServerURL(String serverUrl, java.util.Map<String, String> params) {
			this.sdkConfiguration.serverUrl = com.testworkspace2.pet.api_name_pet.utils.Utils.templateUrl(serverUrl, params);
			return this;
		}
		 ...
		 */
		public ApiNamePet build() throws Exception {
			...
			return new ApiNamePet(this.sdkConfiguration);
		}
	}
	...
	private ApiNamePet(SDKConfiguration sdkConfiguration) throws Exception {
